...
> **تحديث:** أُصلحت لاحقاً كل الأخطاء المحاسبية وحُذف الكود الميت — راجع `CODE_FIXES.md`
> لقائمة ما أُصلح بالضبط وما بقي متعمَّداً. نظام الترخيص لم يُلمس (حسب التعليمات الصريحة
> في `CLAUDE.md`)، ومشاكله مُدرَجة هنا للعلم فقط.
